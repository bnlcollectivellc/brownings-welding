...
export default function Footer() {
  return (
    <footer className="bg-browning-charcoal border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[78px] pb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-gray-400">
                ...
                <a
                  href="https://www.google.com/maps/search/?api=1&query=163+Shaw+Bridge+Rd+Greenbrier+AR+72058"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-browning-red transition-colors"
                >
                  163 Shaw Bridge Rd,<br />Greenbrier, AR 72058
                </a>
              </li>
